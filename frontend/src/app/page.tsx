    ...
    <div className="space-y-12">
      ...
      <section className="relative overflow-hidden rounded-xl bg-emerald-700 text-yellow-100">
        ...
        <div className="px-6 py-14 sm:px-10 sm:py-16">
          ...
          <p className="mt-4 max-w-2xl text-emerald-50 text-lg">
            ...
            Teile Überschüsse, entdecke Besonderes aus der Nachbarschaft und
            lasse Pflanzen ein neues Zuhause finden.
          </p>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <article className="rounded-lg bg-white/70 backdrop-blur p-5 shadow-sm border border-emerald-100">
          ...
          <p className="mt-2 text-emerald-900/80">
            Kürbisse 🎃, Äpfel 🍎, Zucchini oder Kräuter – biete Überschüsse an
            oder entdecke saisonale Schätze in deiner Nähe.
          </p>
        </article>
        <article className="rounded-lg bg-white/70 backdrop-blur p-5 shadow-sm border border-emerald-100">
          ...
          <p className="mt-2 text-emerald-900/80">
            Ableger, Büsche, Stauden 🌱 – verschenke oder tausche, damit Gutes
            weiterwächst.
          </p>
        </article>
        <article className="rounded-lg bg-white/70 backdrop-blur p-5 shadow-sm border border-emerald-100">
          ...
          <p className="mt-2 text-emerald-900/80">
            Lerne andere Kleingärtner:innen kennen, tausche Tipps und baue ein
            lokales Netzwerk auf.
          </p>
        </article>
      </section>
      ...
      <section className="rounded-xl bg-white/80 backdrop-blur p-6 shadow-sm border border-emerald-100">
        ...
        <ol className="mt-4 grid gap-4 sm:grid-cols-3 hiw-steps">
          <li className="rounded-md border border-emerald-100 bg-white p-6">
            ...
            <p className="text-emerald-900/80">
              Nutze die Suche oben - z.B. &quot;Äpfel&quot; oder
              &quot;Ableger&quot;, optional mit Ort/PLZ.
            </p>
          </li>
          <li className="rounded-md border border-emerald-100 bg-white p-6">
            <p className="font-semibold text-emerald-900">Kontakt aufnehmen</p>
            <p className="text-emerald-900/80">
              Vereinbare Abholung oder Tausch direkt in der Nachbarschaft.
            </p>
          </li>
          <li className="rounded-md border border-emerald-100 bg-white p-6">
            <p className="font-semibold text-emerald-900">Selbst anbieten</p>
            <p className="text-emerald-900/80">
              Stelle deine eigenen Angebote ein - vom Überschuss bis zur
              besonderen Pflanze.
            </p>
          </li>
        </ol>
        <div className="mt-6">
          <a
            href="#search-item"
            className="inline-block rounded-sm bg-emerald-700 px-4 py-2 font-semibold text-yellow-100 hover:bg-emerald-800"
          >
            Jetzt loslegen
          </a>
        </div>
