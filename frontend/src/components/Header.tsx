        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
          ...
          >
              ...
              <div className="relative">
                <span aria-hidden="true" className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-2 text-gray-500">
                  {/* Magnifying glass icon */}
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6">
                    <path fillRule="evenodd" d="M9 3.5a5.5 5.5 0 1 0 3.473 9.78l3.623 3.624a.75.75 0 1 0 1.06-1.06l-3.624-3.624A5.5 5.5 0 0 0 9 3.5ZM5 9a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z" clipRule="evenodd" />
                  </svg>
                </span>
                <input
                  id="search-item"
            ...
            <div className="md:w-80">
              ...
              <div className="relative">
                <span aria-hidden="true" className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-2 text-gray-500">
                  {/* Location pin icon */}
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6">
                    <path fillRule="evenodd" d="M10 2a6 6 0 0 0-6 6c0 4.418 6 10 6 10s6-5.582 6-10a6 6 0 0 0-6-6Zm0 8.5a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5Z" clipRule="evenodd" />
                  </svg>
                </span>
                <input
                  id="search-location"
